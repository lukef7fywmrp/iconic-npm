      ...
      <div className="relative">
        <div className="before:gradient group p-0.5 font-author text-lg">
          <button className="group relative inline-flex items-center justify-start overflow-hidden rounded-md px-5 py-1 font-normal">
            <span className="h-34 absolute left-0 top-0 w-32 translate-x-12 -translate-y-2 rotate-45 bg-white opacity-[0%]"></span>
            <span className="absolute top-0 left-0 -mt-1 h-44 w-48 -translate-x-56 -translate-y-24 rotate-45 bg-white opacity-100 transition-all duration-500 ease-in-out group-hover:-translate-x-8"></span>
