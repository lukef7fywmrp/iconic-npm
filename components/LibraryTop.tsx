      ...
      <div className="flex w-full flex-col items-center justify-center space-y-3 rounded-2xl bg-white/5 py-5 px-10 transition duration-500 hover:bg-white/10">
        <div className="group flex flex-col items-center space-y-3 px-10 font-author">
          <div className="relative ">
            <div className="before:gradient flex h-24 w-24 items-center rounded-3xl bg-white p-2  before:rounded-3xl before:border-[2.5px]">
        ...
        {/* Button */}
        <div className="relative">
          <div className="before:gradient group p-0.5 font-author text-lg before:rounded-xl">
            <button className="group relative inline-flex items-center justify-start overflow-hidden rounded-[10px] px-5 py-1 font-normal">
