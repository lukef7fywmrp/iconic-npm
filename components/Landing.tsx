...
function Landing() {
  ...
  return (
    <div className="flex flex-col max-w-[1300px] mx-auto text-white px-16 items-center justify-center w-full h-full font-author tracking-wide space-y-10 py-10">
      {/* Video */}
      <div className="space-x-10 flex rounded-xl overflow-auto px-[10%] w-full">
        <iframe
      ...
      <div className="flex flex-col justify-center items-center w-full text-center space-y-10 ">
        ...
        <div className="bg-gradient-to-tr from-[#50afeb] to-[#cd0789] p-[1px] rounded-md">
          <div className="flex bg-[#010410] rounded-md">
